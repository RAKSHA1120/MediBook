...
import PatientVisitorCards from "../pages/PatientVisitorCards";
  ...
  return (
    <ErrorBoundary>
      <Routes>
        ...
        <Route path="/visitor-cards" element={<PatientLayout><PatientVisitorCards /></PatientLayout>} />
        <Route path="/hospital-visitor-cards" element={<PatientLayout><PatientVisitorCards /></PatientLayout>} />
